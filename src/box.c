...
void test_dunion()
{
    ...
    hinter = (hinter - inter)/(.0001);
     fprintf(stderr, "Union Manual %f %f %f %f\n", xinter, yinter, winter, hinter);
}
void test_dintersect()
{
    ...
    winter = (winter - inter)/(.0001);
    hinter = (hinter - inter)/(.0001);
     fprintf(stderr, "Inter Manual %f %f %f %f\n", xinter, yinter, winter, hinter);
}
